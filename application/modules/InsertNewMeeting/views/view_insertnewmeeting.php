    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo base_url(); ?>Antrianadmin/index">
                        ...
                        <div class="col-lg-6 mb-4 col-xl">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo base_url('Insertnewmeeting/Insertdata'); ?>" method="post">
                                        <div class="form-group">
                                            <label for="focusedinput">ID Ruang Meeting Baru</label>
                                            <div>
                                                <!-- <input type="hidden" name="idregis" class="form-control" id="focusedinput" value="" /> -->
                                                <input type='text' name='idmeeting' class='form-control' id='focusedinput' value="" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="nama">Nama Ruangan</label>
                                            <div>
                                                <input type="text" name='namaruangan' class="form-control" id='namaruangan' value="" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" name='kapasitasruangan' class="form-control" id='kapasitasruangan' value="" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form_group">
                                            ...
                                            <div>
                                                <textarea type='text' name='fasilitas' class='form-control' id='fasilitas' placeholder='' value=""> </textarea>
                                            </div>
                                        </div>
                                        <br>
                                        <div class="form_group">
                                        ...
                                        <br>
                                        <br>
                                        <button type="submit" class="btn btn-primary btn-block">Ajukan Ruangan</button>
                                    </form>
