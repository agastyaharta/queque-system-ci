            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Detail Ruang Meeting</h1>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <input type='text' name='idregis' class='form-control' id='focusedinput' />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <br>
                                    <div class="form_group">
                                        <label for="focusedinput">Masukkan Gambar Baru</label>
                                        <div>
                                    ...
                                    <br>
                                    <br>
                                    <button type="submit" class="btn btn-primary btn-block" id="updatePasien" name="updatePasien">Ubah</button>
                                </div>
