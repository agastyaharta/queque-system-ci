            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Ruang Meeting Baru</h1>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="form_group">
                                        <label for="focusedinput">Gambar Ruangan</label>
                                        <div>
                                    ...
                                    <div class="form-group">
                                        <label for="focusedinput">ID Ruang Meeting</label>
                                        <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type='text' name='Partisipan' class='form-control' id='Partisipan' disabled value="" /> 
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="focusedinput">Lokasi (Lantai)</label>
                                        <div>
                                            <input type='text' name='Partisipan' class='form-control' id='Partisipan' disabled value="" />
                                        </div>
                                    </div>
                                    <div class="form_group">
                                        <label for="focusedinput">Fasilitas</label>
                                        <div>
                                            <textarea type='date' name='Tglpakai' class='form-control' id='Tglpakai' disabled value=""> </textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <br>
                                    <form action="<?php echo base_url(); ?>Meetingform/index" method="POST">
                                        <input type="hidden" name="id" value="' . $id . '">
                                        <button class="btn btn-success btn-block">Pilih Ruangan</button></form>
                                </div>
