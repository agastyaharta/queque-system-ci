...
<head>
    ...
    <title>Antrian Ruang Meeting</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Antrian Ruang Meeting</h1>
                        ...
                        <div class="col-lg-6 mb-4 col-xl">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Daftar Antrian Ruang Meeting</h6>
                                </div>
                                <!-- Disini -->
                                <div class="card-body">
                                    <table id="lookup" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            foreach ($dataAntrian->result() as $listdat) { }
                                            ?>
                                            <tr>
                                                <td><?php echo $listdat->registrationid; ?> </td>
                                                <td><?php echo $listdat->employeename; ?> </td>
                                                <td><?php echo $listdat->roomname; ?> </td>
                                                <td><?php echo $listdat->datetimeusage; ?> </td>
                                                <td><span><?php echo $listdat->registrationstatus; ?></span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
