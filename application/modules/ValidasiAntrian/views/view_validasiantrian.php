            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Validasi Ruang Antrian</h1>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <table id="lookup" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            foreach ($dataValidasi->result() as $listdat) { }
                                            ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="<?php echo base_url(); ?>Editpasien/index" method="POST">
                                                        ...
                                                        <button class="btn btn-success btn-block">Setuju</button></form>
                                                    <br>
                                                    <form action="<?php echo base_url(); ?>Editpasien/index" method="POST">
                                                        <input type="hidden" name="id" value="' . $id . '">
                                                        <button class="btn btn-danger btn-block">Tolak</button></form>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
