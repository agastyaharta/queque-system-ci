                                    ...
                                    <table id="lookup" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="<?php echo base_url(); ?>Detailruangmeeting/index" method="POST">
                                                        <input type="hidden" name="id" value="' . $id . '">
                                                        <button class="btn btn-success btn-block">Edit</button></form>

                                                    <br>

                                                    <form action="<?php echo base_url(); ?>Editpasien/index" method="POST">
                                                        <input type="hidden" name="id" value="' . $id . '">
                                                        <button class="btn btn-danger btn-block">Delete</button></form>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
