...
<head>
    ...
    <title>Daftar Ruang Meeting</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Daftar Ruang Meeting</h1>
                        ...
                        <div class="col-lg-6 mb-4 col-xl">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Daftar Ruang Meeting Tersedia</h6>
                                </div>
                                <!-- Disini -->
                                <div class="card-body">
                                    <table id="lookup" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            foreach ($dataRuangan->result() as $listdat) { }
                                            ?>
                                                <td><?php echo $listdat->roomid; ?> </td>
                                                <td><?php echo $listdat->roomname; ?> </td>
                                                <td><?php echo $listdat->capacity; ?> </td>
                                                <td>
                                                    <form action="<?php echo base_url(); ?>Showruangmeeting/index" method="POST">
                                                        <input type="hidden" name="id" value="' . $id . '">
                                                        <button class="btn btn-success btn-block">More</button></form>
                                                </td>
                                                </tr>
                                        </tbody>
                                    </table>
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; Sistem Antrian Ruang Meeting</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
